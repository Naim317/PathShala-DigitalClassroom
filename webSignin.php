...
if(isset($_POST["submit"])){
  ...
  if($password == $password2){
    $query = "INSERT INTO pathshaladata(name,class,address,email,phone,password,role) VALUES ('$name','$class','$address','$email','$phone','$password','$role')";
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 float-right">
                    <form class="formCustom form my-3" id="signup" method="POST">
                        ...
                        <div class="form-outline mb-4">
                          <input type="text" id="num" name="class" class="form-control" />
                          <small></small>
