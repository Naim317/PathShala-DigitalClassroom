...
if(isset($_POST["submit"])){
    if(isset($_POST["submit"])){
      ...
      if($data==mysqli_fetch_assoc($result)){ ?>
        <script>window.location="webDashboard.php";</script>
    <?php
      }
      else{
        ?>
    <script>alert("Username or Password did not matched");</script>
    <?php
      }
    }
}
    ...
    <nav class="navbar navbar-dark w-100 upperNav">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            <img src="images/classroom.png" class="navBrandCust float-left" alt=""><span class="upperNavText">Pathshala</span> 
          </a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="webDashboard.php" method="Post">
            <!-- Email input -->
        ...
        <div class="topBannerOverlay">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="clearfix"></div>
                    <P class="qouteTxt mt-3 text-center"><i class="fa fa-quote-left" style="color: wheat;" aria-hidden="true"></i><span> If You are planning for a year, sow rice; if you are planning for a decade, plant trees; if you are planning for a lifetime, educate people – <span class="fs-5">Chinese Proverb</span></span><i class="fa fa-quote-right" style="color: wheat;" aria-hidden="true"></i></P>
                </div>
                <div class="row">
                  <div class="col-12">
                    <div class="btnWrap mt-5">
                      <button class="btn btn-danger btn-rounded btn-lg btnCust float-left"><i class="fas fa-chalkboard-teacher" style="color: black;"></i> Go to Pathshala</button>
                      <button class="btn btn-info btn-rounded btn-lg btnCust float-left ml-3 btnSU"><i class="fa fa-sign-in" style="color: black;" aria-hidden="true"></i> Sign Up</button>
                    </div>
                  </div>
                </div>
            </div>
